...
class WordDetailsFragmentInitialArgs(private val argsSource: WordDetailsFragmentArgs) : ViewModelInitialArgs {
    fun getWordItem(): SearchResultModel = argsSource.wordItem
}
